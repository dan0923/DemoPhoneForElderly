package sg.edu.rp.c346.id18015497.demophoneforelderly;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDghtr = findViewById(R.id.buttonCallDaughter);
        ...
        btnDghtr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
